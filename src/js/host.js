 ...
 * @memberOf Gamepad
 */
Gamepad.prototype.peerHandshake = function (peerId) {
 ...
 * @memberOf Gamepad
 */
Gamepad.prototype.peerConnect = function (peer) {
  return new Promise(function (resolve, reject) {
...
Gamepad.prototype.pair = function (peerId) {
  return new Promise(function (resolve) {
    ...
    return gamepad.peerHandshake(peerId).then(function (peer) {
      ...
      this.peerConnect(peer).then(function (conn) {
 ...
 *
 * @param {String} eventName The name of events from which to remove the function.
 * @param {Function} func The serialised set to load.
 * @memberOf Index
 */
